...
import toolImg from "../assets/mobiledev.jpg";
import showimg from "../assets/mobiledevlopment.jpg";
...
const MobileDevelopment = () => {
  ...
  //     title: "Native Apps",
  //     description:
  //       "High-performance native mobile applications built specifically for iOS and Android platforms.",
  //     services: [
  //       {
  //         icon: <Code className="w-6 h-6" />,
  //         title: "iOS Development",
  //         description: "Swift & SwiftUI apps",
  //       },
  //       {
  //         icon: <Smartphone className="w-6 h-6" />,
  //         title: "Android Development",
  //         description: "Kotlin & Java apps",
  //       },
  //       {
  ...
  const solutions = [
    ...
    },
    {
      ...
      description:
        "Cost-effective solutions that work seamlessly across multiple platforms using React Native and Flutter.",
      services: [
        {
          icon: <Palette className="w-6 h-6" />,
          title: "React Native",
        ...
        },
        {
          icon: <Smartphone className="w-6 h-6" />,
          title: "Code Sharing",
          description: "Efficient development",
        },
        {
          icon: <Shield className="w-6 h-6" />,
          title: "Performance",
          description: "Native-like speed",
        },
      ],
    },
    {
      ...
      title: "AI & Automation",
      description:
        "Smart automation solutions powered by artificial intelligence and machine learning capabilities.",
      services: [
        {
          icon: <Code className="w-6 h-6" />,
    ...
    },
    {
      ...
      description:
        "Comprehensive maintenance and support services to keep your mobile apps running smoothly.",
      services: [
        {
          icon: <Server className="w-6 h-6" />,
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            <div className="max-w-2xl text-left">
              ...
              <p className="text-lg md:text-xl text-gray-200">
                Crafting seamless and innovative mobile experiences tailored to
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="order-1 lg:order-2 space-y-6">
              ...
              <div className="space-y-3 text-gray-700">
                <p className="text-md leading-relaxed">
                  ...
                  user-friendly and high-performance applications for both iOS
                  and Android platforms. We leverage the latest technologies and
                  best practices to deliver solutions that meet your business
                  needs.
                </p>
                <p>
                  Our team follows a comprehensive development process, including
                  thorough testing and quality assurance, to ensure your app is
                  reliable and performs well under all conditions.
                </p>
              </div>
            </div>
          </div>
